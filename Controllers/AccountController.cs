    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Сбросьте ваш пароль, щелкнув <a href=\"" + callbackUrl + "\">здесь</a>");
        ...
        string userId, int subscrptionId)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var subscriptions = db.UserSubscriptions.Where(
                        ...
                        us.SubscriptionId.Equals(subscrptionId));
